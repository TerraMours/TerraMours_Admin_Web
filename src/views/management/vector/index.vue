  ...
  <div class="h-full overflow-y-auto">
    <n-card  :bordered="false" class="rounded-16px shadow-sm">
          ...
          <n-button size="small" type="primary" >
			...
			<n-space vertical class="pb-20px ">
					<gradient-bg  start-color="#ec4786" end-color="#b955a4">
								<h3 class="text-50px">test</h3>
								<div class="flex justify-between pt-12px">
									<n-space>
									<n-space vertical align="start">
										<h3 class="mr-10px text-20px">METRIC</h3>
										<h3 class="mr-10px text-15px" >cosine</h3>
									</n-space>
									<n-space vertical align="start">
										<h3 class="mr-10px text-20px">Host</h3>
										<h3 class="mr-10px text-15px" >https://test-index-z8cohba.svc.gcp-starter.pinecone.io</h3>
									</n-space>
									</n-space>
									<n-space vertical align="end">
										<h3 class="mr-10px text-20px">VECTOR COUNT</h3>
										<h3 class="mr-10px text-15px" >3</h3>
									</n-space>
								</div>
					</gradient-bg>
			</n-space>
      <n-space class="pb-12px" vertical>
        ...
        <n-input-group class="mr-10px" :style="{ width: '70%' } ">
...
import {fetchDelUser, fetchVectorList} from "@/service";
...
const nameSpaceOptions: { label: string; value: number,disabled: boolean}[] = []
const nameSpaceString=ref('test-namespace');
